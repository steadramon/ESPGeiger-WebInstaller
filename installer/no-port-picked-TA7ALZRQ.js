import{G as c,a as n,b as r,c as o,d as s,j as a,k as d}from"./chunk-KNTSFZMZ.js";import"./chunk-SQE76S5B.js";var w=()=>{var t,e;let u=window.navigator.userAgent,i=((e=(t=window.navigator)===null||t===void 0?void 0:t.userAgentData)===null||e===void 0?void 0:e.platform)||window.navigator.platform,p=["macOS","Macintosh","MacIntel","MacPPC","Mac68K"],m=["Win32","Win64","Windows","WinCE"],g=["iPhone","iPad","iPod"];return p.indexOf(i)!==-1?"Mac OS":g.indexOf(i)!==-1?"iOS":m.indexOf(i)!==-1?"Windows":/Android/.test(u)?"Android":/Linux/.test(i)?"Linux":null};var h=s`
  <svg
    version="1.1"
    id="Capa_1"
...
`,l=class extends a{render(){let e=w();return o`
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  >
                  <br />
                  (download via blue button with ${h} icon)
                </li>
                <li>
                  CH340, CH341 drivers:
                  <a
    ...
    `}tryAgain(){var e;this.close(),(e=this.doTryAgain)===null||e===void 0||e.call(this)}close(){this.shadowRoot.querySelector("ew-dialog").close()}async _handleClose(){this.parentNode.removeChild(this)}};l.styles=[c,r`
      li + li,
      li > ul {
        margin-top: 8px;
      }
    ...
    `];l=n([d("ewt-no-port-picked-dialog")],l);var S=async t=>{let e=document.createElement("ewt-no-port-picked-dialog");return e.doTryAgain=t,document.body.append(e),!0};export{S as openNoPortPickedDialog};
